		...
		<div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-body">
					<form class="form-inline" id="form" action="${pageContext.request.contextPath }/customerList" method="get">
                        ...
                        <div class="form-group" style="display: none" >
                            ...
                            <input style="width: 50px" type="text" class="form-control" id="size" value="${customerQuery.pageSize}" name="pageSize">
                        </div>
                        <div class="form-group"  style="display: none" >
                            <label for="customerName">跳转</label>
                            <input style="width: 50px" type="text" class="form-control" id="page" value="${customerQuery.pageNum}" name="pageNum">
                            页
                        </div>
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="col-md-12 text-right">
                            <jsp:include page="pageNavigation.jsp"></jsp:include>
                        </div>
